...
foom::db::db(Path const &dbpath, db_gender gender, bool readPersons, db_size playersCount) {
    ...
    // read weather
    ReaderCallback(L"fm_weather", [&](FifamReader &reader) {
        weather w;
        reader.ReadLine(w.mID, w.mName, w.mSpringStartDay, w.mSpringPrecipitationDry, w.mSpringPrecipitationWet, w.mSpringPrecipitationDrizzle, w.mSpringPrecipitationShower, w.mSpringPrecipitationDownPour, w.mSpringWindCalm, w.mSpringWindBreezy, w.mSpringWindGusty, w.mSpringWindStrong, w.mSpringWindGale, w.mSpringTemperatureExtremelyFreezing, w.mSpringTemperatureVeryFreezing, w.mSpringTemperatureFreezing, w.mSpringTemperatureCold, w.mSpringTemperatureMild, w.mSpringTemperatureFine, w.mSpringTemperatureWarm, w.mSpringTemperatureHot, w.mSpringTemperatureVeryHot, w.mSpringTemperatureExtremelyHot, w.mSpringTemperatureDayNightVariance, w.mSummerStartDay, w.mSummerPrecipitationDry, w.mSummerPrecipitationWet, w.mSummerPrecipitationDrizzle, w.mSummerPrecipitationShower, w.mSummerPrecipitationDownPour, w.mSummerWindCalm, w.mSummerWindBreezy, w.mSummerWindGusty, w.mSummerWindStrong, w.mSummerWindGale, w.mSummerTemperatureExtremelyFreezing, w.mSummerTemperatureVeryFreezing, w.mSummerTemperatureFreezing, w.mSummerTemperatureCold, w.mSummerTemperatureMild, w.mSummerTemperatureFine, w.mSummerTemperatureWarm, w.mSummerTemperatureHot, w.mSummerTemperatureVeryHot, w.mSummerTemperatureExtremelyHot, w.mSummerTemperatureDayNightVariance, w.mAutumnStartDay, w.mAutumnPrecipitationDry, w.mAutumnPrecipitationWet, w.mAutumnPrecipitationDrizzle, w.mAutumnPrecipitationShower, w.mAutumnPrecipitationDownPour, w.mAutumnWindCalm, w.mAutumnWindBreezy, w.mAutumnWindGusty, w.mAutumnWindStrong, w.mAutumnWindGale, w.mAutumnTemperatureExtremelyFreezing, w.mAutumnTemperatureVeryFreezing, w.mAutumnTemperatureFreezing, w.mAutumnTemperatureCold, w.mAutumnTemperatureMild, w.mAutumnTemperatureFine, w.mAutumnTemperatureWarm, w.mAutumnTemperatureHot, w.mAutumnTemperatureVeryHot, w.mAutumnTemperatureExtremelyHot, w.mAutumnTemperatureDayNightVariance, w.mWinterStartDay, w.mWinterPrecipitationDry, w.mWinterPrecipitationWet, w.mWinterPrecipitationDrizzle, w.mWinterPrecipitationShower, w.mWinterPrecipitationDownPour, w.mWinterWindCalm, w.mWinterWindBreezy, w.mWinterWindGusty, w.mWinterWindStrong, w.mWinterWindGale, w.mWinterTemperatureExtremelyFreezing, w.mWinterTemperatureVeryFreezing, w.mWinterTemperatureFreezing, w.mWinterTemperatureCold, w.mWinterTemperatureMild, w.mWinterTemperatureFine, w.mWinterTemperatureWarm, w.mWinterTemperatureHot, w.mWinterTemperatureVeryHot, w.mWinterTemperatureExtremelyHot, w.mWinterTemperatureDayNightVariance);
        mWeather[w.mID] = w;
    });
    // read names
