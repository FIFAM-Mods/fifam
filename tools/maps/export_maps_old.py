...
EXPORT_FILTER = [ "Portugal", "Açores", "Madeira", "Russia", "Kaliningrad", "Spain", "Canary Islands", "Chile", "Hanga Roa", "Ecuador", "Puerto Ayora", "United States", "Alaska", "Hawaii", "Equatorial Guinea", "San Antonio de Palé", "American Samoa", "Manua Islands", "Cook Islands", "Rarotonga", "Aitutaki" ]      # e.g. ["Ukraine", "France", "Germany"]
