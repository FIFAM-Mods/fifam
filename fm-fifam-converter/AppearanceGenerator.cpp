...
void AppearanceGenerator::SetFromFifaPlayer(FifamPlayer *player, FifaPlayer *fifaPlayer) {
    ...
    if (!fifaHairSet) {
        static Map<UInt, UInt> fifaHairsPC = {
            { 159, 45 },{ 160, 35 },{ 161, 17 },{ 162, 132 },{ 163, 27 },{ 164, 70 },{ 165, 26 },{ 166, 71 },{ 167, 66 },{ 168, 217 },{ 169, 18 },{ 170, 73 },{ 171, 10 },{ 172, 17 },{ 173, 171 },{ 174, 18 },{ 175, 35 },{ 176, 41 },{ 177, 72 },{ 178, 25 },{ 179, 38 },{ 180, 119 },{ 181, 15 },{ 182, 73 },{ 183, 15 },{ 184, 18 },{ 185, 171 },{ 186, 40 },{ 187, 25 },{ 188, 50 },{ 189, 24 },{ 190, 35 },{ 191, 24 },{ 192, 24 },{ 193, 217 },{ 194, 20 },{ 195, 10 },{ 196, 21 },{ 197, 30 },{ 198, 39 },{ 199, 30 },{ 200, 29 },{ 201, 9 },{ 202, 10 },{ 204, 73 },{ 205, 35 },{ 206, 6 },{ 207, 52 },{ 208, 18 },{ 209, 52 },{ 211, 14 },{ 212, 18 },{ 218, 15 },{ 219, 32 },{ 220, 35 },{ 221, 19 },{ 222, 27 },{ 223, 73 },{ 225, 83 },{ 226, 84 },{ 227, 6 },{ 228, 124 },{ 229, 73 },{ 230, 35 },{ 231, 13 },{ 232, 45 },{ 233, 38 },{ 234, 36 },{ 235, 52 },{ 236, 36 },{ 237, 49 },{ 239, 15 },{ 240, 12 },{ 241, 28 },{ 242, 19 },{ 243, 19 },{ 244, 73 },{ 245, 73 },{ 250, 6 },{ 257, 104 },{ 263, 112 },{ 264, 162 },{ 267, 208 },{ 273, 124 },{ 274, 187 },{ 275, 38 },{ 277, 20 },{ 278, 32 },{ 280, 83 },{ 283, 25 },{ 284, 19 },{ 285, 27 },{ 289, 17 },{ 290, 8 },{ 291, 13 },{ 292, 37 },{ 294, 28 },{ 295, 15 },{ 296, 187 },{ 297, 7 },{ 298, 41 },{ 299, 77 },{ 376, 88 },{ 390, 12 },{ 419, 83 },{ 431, 203 },{ 434, 137 },{ 445, 40 },{ 446, 15 },{ 450, 110 },{ 451, 11 },{ 460, 197 },{ 463, 18 },{ 630, 20 },{ 631, 128 },{ 632, 119 },{ 633, 82 },{ 634, 128 },{ 635, 24 },{ 636, 41 },{ 637, 101 },{ 638, 16 },{ 639, 40 },{ 640, 18 },{ 641, 69 },{ 642, 28 },{ 643, 14 },{ 644, 82 },{ 645, 48 },{ 646, 17 }
        };
        if (fifaHairsPC.contains(fifaPlayer->internal.hairtypecode)) {
            auto hairId = fifaHairsPC[fifaPlayer->internal.hairtypecode];
            if (hairId > 0 && hairId <= std::size(g14HairEditorIdToReal)) {
                player->mAppearance.mHairStyle = g14HairEditorIdToReal[44 - 1];
                fifaHairSet = true;
            }
        }
