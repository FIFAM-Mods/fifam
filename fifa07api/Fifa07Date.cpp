...
Fifa07Date::Fifa07Date() : Date() {}

Fifa07Date::Fifa07Date(unsigned int DaysCount) { Set(DaysCount); }

unsigned int Fifa07Date::GetDays() {
...
void Fifa07Date::Set(unsigned int Days) {
