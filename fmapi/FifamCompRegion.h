...
ENUM_BEGIN(FifamCompRegion, UChar)
    ...
    ENUM_MEMBER(249, Europe,                L"Europe")
    ENUM_MEMBER(250, SouthAmerica,          L"South America")
    ENUM_MEMBER(251, NorthAmerica,          L"North America")
    ENUM_MEMBER(252, Africa,                L"Africa")
    ENUM_MEMBER(253, Asia,                  L"Asia")
    ENUM_MEMBER(254, Oceania,               L"Oceania")
    ENUM_MEMBER(255, International,         L"International")
